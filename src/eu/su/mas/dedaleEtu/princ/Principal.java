...
//		agentList.add(ag);	
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParameters2={"My parameters 1"};
		...
		ag=createNewDedaleAgent(c, agentName, ExploreSoloAgent.class.getName(), entityParameters5);
		agentList.add(ag);
		...
		Assert.assertNotNull("This container does not exist",c);
		agentName="Tanker";
		Object [] entityParameters6={"My parameters"};
		ag=createNewDedaleAgent(c, agentName, TankerAgent.class.getName(), entityParameters6);
		agentList.add(ag);
